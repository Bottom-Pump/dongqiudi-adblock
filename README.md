...
> 专为懂球帝 APP 定制的 Magisk 广告屏蔽模块，作者自用分享
...
> **⚠️ 免责声明**：本模块为作者自用分享，能屏蔽 **绝大多数** 广告（开屏、信息流、文章内嵌等），但由于广告 SDK 持续更新、部分广告走 HTTPS 加密等因素，偶尔仍可能出现开屏广告或信息流广告。介意的用户请斟酌使用。

## 实际效果

| 开屏界面 | 信息流 | 文章内 |
|:--------:|:------:|:------:|
| ![开屏图](screenshots/开屏图.jpg) | ![信息流](screenshots/信息流.jpg) | ![文章内](screenshots/文章内.jpg) |

> 效果因 Android 版本、系统内核、懂球帝 APP 版本而异，以实际体验为准。
...
> **💡 使用体验**：刚刷入重启后前几次打开懂球帝可能还会弹出开屏广告，这是 SDK 缓存尚未完全清理干净。正常使用片刻后，开屏将变为纯净的无广告背景图。日常使用中能屏蔽大部分广告，但偶尔仍可能出现开屏或信息流广告，这属于正常现象。
